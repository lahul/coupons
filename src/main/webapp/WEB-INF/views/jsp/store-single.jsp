                            ...
                            <div class="navbar-collapse collapse">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown hasmenu">
                                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown">Pages <span class="fa fa-angle-down"></span></a>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="post-media text-center">
                                        <a href="coupon-single.jsp"><img src="uploads/store.png" alt="" class="img-responsive"></a>
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <div class="coupon-meta">
                                        <h3>Connect.com <small><a href="store-single.jsp"><i class="fa fa-rss"></i> Subscribe this Store</a></small></h3>
                                        ...
                                        <div class="coupon-wrapper">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    ...
                                                    <div class="coupon-bottom clearfix">
                                                        <small class="pull-left">Expire : 21/07/2016</small>
                                                        <small class="pull-right"><a href="store-single.jsp"><i class="fa fa-comment-o"></i> 44 Comments</a></small>
                                                    </div>
                                                    <!-- end coupon-top -->
                                                </div>
                                                <!-- end col -->
                                        ...
                                        <div class="coupon-wrapper">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    ...
                                                    <div class="coupon-bottom clearfix">
                                                        <small class="pull-left">Expire : 21/07/2016</small>
                                                        <small class="pull-right"><a href="store-single.jsp"><i class="fa fa-comment-o"></i> 6 Comments</a></small>
                                                    </div>
                                                    <!-- end coupon-top -->
                                                </div>
                                                <!-- end col -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                    <div class="coupon-meta">
                                                        ...
                                                        <!-- end coupon-top -->
                                                        <h3><a href="coupon-single.jsp">MyLogo.com 10$ off Printable Coupon</a></h3>
                                            ...
                                            <div id="code_id_14" class="modal fade code-modal print-modal">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                            <h4><a href="coupon-single.jsp">MyLogo.com 10$ off Printable Coupon</a></h4>
                                                        </div>
                                                        <div class="modal-body">
