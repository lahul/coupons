                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown hasmenu">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="store-single.jsp">Store Single</a></li>
                                            <li><a href="coupon-single.jsp">Coupon Single</a></li>
                                            <li><a href="category-single.jsp">Category Single</a></li>
                                            <li><a href="single.jsp">Blog Single</a></li>
                                            <li><a href="page-contact.jsp">Contact us</a></li>
                                            <li><a href="page.jsp">Default Page</a></li>
                                            <li><a href="errror.jsp">Not Found</a></li>
                                            <li><a href="page-elements.jsp">All Elements</a></li>
                                        </ul>
                                    </li>
                                    <li><a class="" href="coupons.jsp" title="">Coupons</a></li>
                                    <li><a href="printable.jsp" title="">Printable</a></li>
                                    <li><a href="categories.jsp" title="">Categories</a></li>
                                    <li><a class="" href="stores.jsp" title="">Stores</a></li>
                                    <li><a href="blog.jsp" title="">Blog</a></li>
                                </ul>
                                <ul class="nav navbar-nav navbar-right">
                                    <li class="dropdown hasmenu userpanel">
                                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown"><img src="uploads/testi_03.png" alt="" class="img-circle"> <span class="fa fa-angle-down"></span></a>
                                        <ul class="dropdown-menu start-right" role="menu">
                                            <li><a href="user-dashboard.jsp"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                                            <li><a href="user-favorites.jsp"><i class="fa fa-star"></i> Favorite Stores</a></li>
                                            <li><a href="user-saved.jsp"><i class="fa fa-heart-o"></i> Saved Coupons</a></li>
                                            <li><a href="user-submit.jsp"><i class="fa fa-bullhorn"></i> Submit Coupon</a></li>
                    ...
                    <div class="sidebar col-md-4">
                        <div class="widget clearfix">
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="user-dashboard.jsp"><span class="glyphicon glyphicon-off"></span>  Dashboard</a></li>
                                <li><a href="user-favorites.jsp"><span class="fa fa-star"></span>  Favorite Stores</a></li>
                                <li class="active"><a href="user-saved.jsp"><span class="fa fa-heart-o"></span>  Saved Coupons</a></li>
                                <li><a href="user-submit.jsp"><span class="fa fa-bullhorn"></span>  Submit a Coupon</a></li>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="post-media text-center">
                                            <a href="coupon-single.jsp"><img src="uploads/store_01.jpg" alt="" class="img-responsive"></a>
                                            <small><a href="store-single.jsp">View Store Coupons</a></small>
                                        </div><!-- end media -->
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <div class="coupon-meta">
                                            ...
                                            <h3><a href="coupon-single.jsp">50% Discount Coupon from CatiLogoms.com</a></h3>
                                        ...
                                        <div class="coupon-bottom clearfix">
                                            ...
                                            <small class="pull-right"><a href="store-single.jsp"><i class="fa fa-comment-o"></i> 12 Comments</a></small>
                                        </div><!-- end coupon-top -->
                                    </div><!-- end col -->
                                </div><!-- end row -->
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4><a href="coupon-single.jsp">50% Discount Coupon Code from CatiLogoms.com</a></h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <a href="store-single.jsp"><img src="uploads/store_01.jpg" alt="" class="img-responsive"></a>
                        ...
                        <div class="coupon-list list-wrapper">
                            <div class="coupon-wrapper">
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="post-media text-center">
                                            <a href="coupon-single.jsp"><img src="uploads/store_13.jpg" alt="" class="img-responsive"></a>
                                            <small><a href="store-single.jsp">View Store Coupons</a></small>
                                        </div>
                                        <!-- end media -->
                                    </div>
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <div class="coupon-meta">
                                            ...
                                            <!-- end coupon-top -->
                                            <h3><a href="coupon-single.jsp">Greensoil Printable Coupon Code</a></h3>
                        ...
                        <div class="coupon-list list-wrapper">
                            <div class="coupon-wrapper">
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="post-media text-center">
                                            <a href="coupon-single.jsp"><img src="uploads/store_02.jpg" alt="" class="img-responsive"></a>
                                            <small><a href="store-single.jsp">View Store Coupons</a></small>
                                        </div><!-- end media -->
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <div class="coupon-meta">
                                            ...
                                            <h3><a href="coupon-single.jsp">MyLogo.com 10$ off for all orders</a></h3>
                                        ...
                                        <div class="coupon-bottom clearfix">
                                            <small class="pull-left">Expire : 21/07/2016</small>
                                            <small class="pull-right"><a href="store-single.jsp"><i class="fa fa-comment-o"></i> 5 Comments</a></small>
                                        </div><!-- end coupon-top -->
                                    </div><!-- end col -->
                                </div><!-- end row -->
                                ...
                                <div id="code_id_02" class="modal fade code-modal">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <h4><a href="coupon-single.jsp">MyLogo.com 10$ off for all orders</a></h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <a href="store-single.jsp"><img src="uploads/store_02.jpg" alt="" class="img-responsive"></a>
                                                        <div class="modal-button">
                                                            <a href="http://themeforest.net" target="_blank" title="" class="btn btn-default btn-block">Visit Store <i class="fa fa-angle-right"></i></a>
                                                        </div>
                                                    </div><!-- end col -->
                        ...
                        <div class="coupon-list list-wrapper">
                            <div class="coupon-wrapper">
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="post-media text-center">
                                            <a href="coupon-single.jsp"><img src="uploads/store_12.jpg" alt="" class="img-responsive"></a>
                                            <small><a href="store-single.jsp">View Store Coupons</a></small>
                                        </div>
                                        <!-- end media -->
                                    </div>
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <div class="coupon-meta">
                                            ...
                                            <!-- end coupon-top -->
                                            <h3><a href="coupon-single.jsp">Follow Skinuque on Facebook get 10% Off</a></h3>
                                ...
                                <div id="code_id_23" class="modal fade code-modal">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <h4><a href="coupon-single.jsp">Follow Skinuque on Facebook get 10% Off</a></h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <a href="store-single.jsp"><img src="uploads/store_12.jpg" alt="" class="img-responsive"></a>
                                                        <div class="modal-button">
                                                            <a href="http://themeforest.net" target="_blank" title="" class="btn btn-default btn-block">Visit Store <i class="fa fa-angle-right"></i></a>
                                                        </div>
                                                    </div><!-- end col -->
                        ...
                        <div class="coupon-list list-wrapper">
                            <div class="coupon-wrapper">
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="post-media text-center">
                                            <a href="coupon-single.jsp"><img src="uploads/store_03.jpg" alt="" class="img-responsive"></a>
                                            <small><a href="store-single.jsp">View Store Coupons</a></small>
                                        </div><!-- end media -->
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <div class="coupon-meta">
                                            ...
                                            <h3><a href="coupon-single.jsp">44$ off CompanieNamis Discount</a></h3>
                                        ...
                                        <div class="coupon-bottom clearfix">
                                            <small class="pull-left">Expire : 21/07/2016</small>
                                            <small class="pull-right"><a href="store-single.jsp"><i class="fa fa-comment-o"></i> 21 Comments</a></small>
                                        </div><!-- end coupon-top -->
                                    </div><!-- end col -->
                                </div><!-- end row -->
                                ...
                                <div id="code_id_03" class="modal fade code-modal">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <h4><a href="coupon-single.jsp">44$ off CompanieNamis Discount</a></h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <a href="store-single.jsp"><img src="uploads/store_03.jpg" alt="" class="img-responsive"></a>
                                                        <div class="modal-button">
                                                            <a href="http://themeforest.net" target="_blank" title="" class="btn btn-default btn-block">Visit Store <i class="fa fa-angle-right"></i></a>
                                                        </div>
                                                    </div><!-- end col -->
                        ...
                        <div class="coupon-list list-wrapper">
                            <div class="coupon-wrapper">
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="post-media text-center">
                                            <a href="coupon-single.jsp"><img src="uploads/store_04.jpg" alt="" class="img-responsive"></a>
                                            <small><a href="store-single.jsp">View Store Coupons</a></small>
                                        </div><!-- end media -->
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <div class="coupon-meta">
                                            ...
                                            <h3><a href="coupon-single.jsp">10% Discount Coupon from KnowLogoDesign</a></h3>
                                        ...
                                        <div class="coupon-bottom clearfix">
                                            <small class="pull-left">Expire : 21/07/2016</small>
                                            <small class="pull-right"><a href="store-single.jsp"><i class="fa fa-comment-o"></i> 51 Comments</a></small>
                                        </div><!-- end coupon-top -->
                                    </div><!-- end col -->
                                </div><!-- end row -->
                                ...
                                <div id="code_id_04" class="modal fade code-modal">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <h4><a href="coupon-single.jsp">10% Discount Coupon from KnowLogoDesign</a></h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <a href="store-single.jsp"><img src="uploads/store_04.jpg" alt="" class="img-responsive"></a>
                                                        <div class="modal-button">
                                                            <a href="http://themeforest.net" target="_blank" title="" class="btn btn-default btn-block">Visit Store <i class="fa fa-angle-right"></i></a>
                                                        </div>
                                                    </div><!-- end col -->
                        ...
                        <div class="coupon-list list-wrapper">
                            <div class="coupon-wrapper">
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="post-media text-center">
                                            <a href="coupon-single.jsp"><img src="uploads/store_05.jpg" alt="" class="img-responsive"></a>
                                            <small><a href="store-single.jsp">View Store Coupons</a></small>
                                        </div><!-- end media -->
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <div class="coupon-meta">
                                            ...
                                            <h3><a href="coupon-single.jsp">Free Shipping for All Orders</a></h3>
                                        ...
                                        <div class="coupon-bottom clearfix">
                                            <small class="pull-left">Expire : 21/07/2016</small>
                                            <small class="pull-right"><a href="store-single.jsp"><i class="fa fa-comment-o"></i> 0 Comment</a></small>
                                        </div><!-- end coupon-top -->
                                    </div><!-- end col -->
                                </div><!-- end row -->
                                ...
                                <div id="code_id_05" class="modal fade code-modal">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <h4><a href="coupon-single.jsp">Free Shipping for All Orders</a></h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <a href="store-single.jsp"><img src="uploads/store_05.jpg" alt="" class="img-responsive"></a>
                                                        <div class="modal-button">
                                                            <a href="http://themeforest.net" target="_blank" title="" class="btn btn-default btn-block">Visit Store <i class="fa fa-angle-right"></i></a>
                                                        </div>
                                                    </div><!-- end col -->
                        ...
                        <div class="coupon-list list-wrapper">
                            <div class="coupon-wrapper">
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="post-media text-center">
                                            <a href="coupon-single.jsp"><img src="uploads/store_06.jpg" alt="" class="img-responsive"></a>
                                            <small><a href="store-single.jsp">View Store Coupons</a></small>
                                        </div><!-- end media -->
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <div class="coupon-meta">
                                            ...
                                            <h3><a href="coupon-single.jsp">$5 for for your next logo design</a></h3>
                                            <p>Get free shipping for all your next orders from this store.. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiolore consectetur.</p>
                                        </div><!-- end meta -->
                                ...
                                <div id="code_id_06" class="modal fade code-modal">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <h4><a href="coupon-single.jsp">$5 for for your next logo design</a></h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <a href="store-single.jsp"><img src="uploads/store_06.jpg" alt="" class="img-responsive"></a>
                                                        <div class="modal-button">
                                                            <a href="http://themeforest.net" target="_blank" title="" class="btn btn-default btn-block">Visit Store <i class="fa fa-angle-right"></i></a>
                                                        </div>
                                                    </div><!-- end col -->
                        ...
                        <div class="coupon-list list-wrapper">
                            <div class="coupon-wrapper">
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="post-media text-center">
                                            <a href="coupon-single.jsp"><img src="uploads/store_07.jpg" alt="" class="img-responsive"></a>
                                            <small><a href="store-single.jsp">View Store Coupons</a></small>
                                        </div><!-- end media -->
                                    </div><!-- end col -->
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <div class="coupon-meta">
                                            ...
                                            <h3><a href="coupon-single.jsp">$10 Credit for new users on Sohbet Molasi</a></h3>
                                            <p>Get free shipping for all your next orders from this store.. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiolore consectetur.</p>
                                        </div><!-- end meta -->
                                        ...
                                        <div class="coupon-bottom clearfix">
                                            <small class="pull-left">Expire : 21/07/2016</small>
                                            <small class="pull-right"><a href="store-single.jsp"><i class="fa fa-comment-o"></i> 11 Comments</a></small>
                                        </div><!-- end coupon-top -->
                                    </div><!-- end col -->
                                </div><!-- end row -->
                                ...
                                <div id="code_id_07" class="modal fade code-modal">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                <h4><a href="coupon-single.jsp">$10 Credit for new users on Sohbet Molasi</a></h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <a href="store-single.jsp"><img src="uploads/store_07.jpg" alt="" class="img-responsive"></a>
                                                        <div class="modal-button">
                                                            <a href="http://themeforest.net" target="_blank" title="" class="btn btn-default btn-block">Visit Store <i class="fa fa-angle-right"></i></a>
                                                        </div>
                                                    </div><!-- end col -->
