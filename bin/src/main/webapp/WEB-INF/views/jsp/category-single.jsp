                        ...
                        <div class="navbar navbar-default" role="navigation">
                            ...
                            <div class="navbar-collapse collapse">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="coupons.jsp" title="">Coupons</a></li>
                                    <li><a href="printable.jsp" title="">Printable</a></li>
                                    <li><a class="active" href="categories.jsp" title="">Categories</a></li>
                                    <li><a href="stores.jsp" title="">Stores</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="post-media text-center">
                                        <a href="coupon-single.jsp"><img src="uploads/category.png" alt="" class="img-responsive"></a>
                                    </div>
                                    <!-- end media -->
                                </div>
                                <!-- end col -->
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    <div class="coupon-meta">
                                        <h3>Automotive <small><a href="store-single.jsp"><i class="fa fa-rss"></i> Subscribe this Category</a></small></h3>
                                        <p>You can add store description goes here. Lorem ipsum donec aliquam, urna quis ornare, tellus enim posuere est, vitae molestie felis odio in massa. Lorliquam, urna quis ornare, tellus enim posuere est, vitae molestie felis odio in massa.Lorem ipsum donec aliquam.</p>
                                    </div>
                                    <!-- end meta -->
