                    ...
                    <div class="sidebar col-md-4">
                        <div class="widget clearfix">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li class="active"><a href="user-favorites.jsp"><span class="fa fa-star"></span>  Favorite Stores</a></li>
                                <li><a href="user-saved.jsp"><span class="fa fa-heart-o"></span>  Saved Coupons</a></li>
                    ...
                    <div class="sidebar col-md-8">
                        <div class="widget clearfix">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="post-media text-center">
                                        <a href="store-single.jsp"><img src="uploads/store_08.jpg" alt="" class="img-responsive"></a>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="post-media text-center">
                                        <a href="store-single.jsp"><img src="uploads/store_09.jpg" alt="" class="img-responsive"></a>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="post-media text-center">
                                        <a href="store-single.jsp"><img src="uploads/store_10.jpg" alt="" class="img-responsive"></a>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="post-media text-center">
                                        <a href="store-single.jsp"><img src="uploads/store_11.jpg" alt="" class="img-responsive"></a>
