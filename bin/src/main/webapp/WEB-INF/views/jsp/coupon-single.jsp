                        ...
                        <div class="navbar navbar-default" role="navigation">
                            ...
                            <div class="navbar-collapse collapse">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a class="active" href="coupons.jsp" title="">Coupons</a></li>
        ...
        <div class="parallax first-section" data-stellar-background-ratio="0.5" style="background-image:url('uploads/parallax_01.jpg');">
            <div class="container">
                <div class="section-title m30 text-center">
                    <h1>50% Discount Coupon from CatiLogoms.com</h1>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        ...
                                        <div class="coupon-bottom clearfix">
                                            ...
                                            <small class="pull-right"><a href="store-single.jsp"><i class="fa fa-comment-o"></i> 3 Comments</a></small>
                                        </div><!-- end coupon-top -->
                                    </div><!-- end col -->
                                </div><!-- end row -->
